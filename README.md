...
- **Plantilla CSV** descargable para saber el formato exacto de importación.
...
Este módulo es opcional: el resto de la herramienta (Nivel 1, Nivel 2, hipótesis por reglas, historial) funciona completo sin ninguna key.
