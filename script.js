...
function renderOportunidades(r){
  ...
  if(!ops.length){
    el.innerHTML = '<p style="margin:0;font-size:12.5px;color:var(--ink-muted);">Todavía no hay oportunidades — son hallazgos de Nivel 2, el espejo positivo de las señales de riesgo.</p>';
    return;
  }
  var IMPACTO_LABEL = {3:'Alto', 2:'Medio', 1:'Bajo'};
