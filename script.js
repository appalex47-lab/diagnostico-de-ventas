:root{
  ...
  *{box-sizing:border-box;}
  ...
  .btn-clear{background:none;border:1px solid var(--border-strong);color:var(--ink-secondary);font-family:var(--sans);font-size:12px;padding:6px 10px;border-radius:6px;cursor:pointer;white-space:nowrap;}
  .btn-clear:hover{border-color:var(--ink-muted);color:var(--ink);}
  ...
  .chk-why{font-size:11px;color:var(--ink-muted);margin:-2px 0 8px 24px;line-height:1.5;}
  ...
  .thead.sku{grid-template-columns:1fr 50px 50px 78px 22px;}
  ...
  .subrow.sku{grid-template-columns:1fr 50px 50px 78px 22px;}
  ...
  .btn-row-remove{width:100%;height:100%;min-height:30px;background:none;border:1px solid var(--border-strong);border-radius:6px;color:var(--ink-muted);font-size:13px;line-height:1;cursor:pointer;}
  .btn-row-remove:hover{border-color:var(--danger);color:var(--danger);}
  .btn-add-row{width:100%;background:none;border:1px dashed var(--border-strong);border-radius:8px;color:var(--accent);font-family:var(--sans);font-size:13px;padding:9px;cursor:pointer;margin:10px 0 4px;}
  .btn-add-row:hover{border-color:var(--accent);background:var(--accent-soft);}
