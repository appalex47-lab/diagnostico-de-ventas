...
- **Asistente flotante (🤖, esquina inferior derecha)** — chat para repreguntar sobre el diagnóstico actual ("¿qué probarías primero?", "¿por qué podría estar cayendo X?"). Usa el mismo contexto real y las mismas reglas anti-invención que el generador de hipótesis; cada respuesta queda marcada como línea a investigar, no como conclusión.
